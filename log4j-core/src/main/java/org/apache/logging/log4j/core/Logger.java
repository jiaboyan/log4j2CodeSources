...
//    参数中的 level是打印日志的方法传递过来的 日志级别：
    ...
    protected class PrivateConfig {
        ...
        boolean filter(final Level level, final Marker marker, final CharSequence msg, final Throwable t) {
            ...
            //判断级别，打印日志api方法的级别不为null，并且 日志api方法的级别 要大于等于  配置的日志级别；
//            intLevel的数值与日志级别相反，日志级别越大intLevel越低；
            return level != null && intLevel >= level.intLevel();
        }
